    ...
    def __post_init__(self):
        ...
        self.fetchers = {
            ...
            "xai": FetcherConfig(
                ...
                max_retries=1,
                requires_auth=False,
                endpoint_key="api.x.ai",
                base_url="https://api.x.ai/v1",
                currency="USD",
            ),
            "cohere": FetcherConfig(
                name="cohere",
                url="https://cohere.com/pricing",
                timeout=30.0,
                max_retries=1,
                requires_auth=False,
                endpoint_key="api.cohere.com",
                base_url="https://api.cohere.com/v2",
                currency="USD",
            ),
            "mistral": FetcherConfig(
                name="mistral",
                url="https://mistral.ai/pricing",
                timeout=60.0,
                max_retries=1,
                requires_auth=False,
                endpoint_key="api.mistral.ai",
            ...
            "baidu": FetcherConfig(
                name="baidu",
                url="https://cloud.baidu.com/doc/WENXINWORKSHOP/s/Fm2vrveyu",
                timeout=30.0,
                max_retries=1,
                requires_auth=False,
                endpoint_key="qianfan.baidubce.com",
